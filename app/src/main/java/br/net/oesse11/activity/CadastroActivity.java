...
public class CadastroActivity extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if ( task.isSuccessful() ){
                    ...
                    try{
                        ...
                        // Se o usuário for atendente chama a activity maps
                        // senão chama a activity requisicoes
                        if( verificaTipoUsuario() == "A" ){
                            startActivity(new Intent(CadastroActivity.this, MenuAtendenteActivity.class ));
                            finish();
                            ...
                            startActivity(new Intent(CadastroActivity.this, MenuTecnicoActivity.class ));
                            finish();
    ...
    public String verificaTipoUsuario(){
        return switchTipoUsuario.isChecked() ? "T" : "A" ;
    }
